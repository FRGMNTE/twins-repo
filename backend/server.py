...
# ============== Static Page Content (Schwangerschaft, BabyAlltag, etc.) ==============
...
@api_router.get("/static-pages/{page_id}")
...
@api_router.get("/admin/static-pages")
async def get_all_static_pages(token: str):
    ...
    # Merge with defaults for pages not in DB yet
    result = {}
...
@api_router.get("/admin/static-pages/{page_id}")
...
@api_router.put("/admin/static-pages/{page_id}")
